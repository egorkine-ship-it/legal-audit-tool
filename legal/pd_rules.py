...
LIABILITY_BY_KIND = {
    "consent": "Обработка ПДн без надлежащего согласия: до 700 000 ₽",
    "policy": "Неопубликование/неполнота политики обработки ПДн: до 100 000 ₽",
    "cross_border": "Трансграничная передача ПДн: отдельная квалификация",
    "localization": "Локализация баз ПДн граждан РФ: до 6 000 000 ₽",
    "ads": "Рекламные сообщения без согласия: до 500 000 ₽",
    "rkn": "Уведомление Роскомнадзора: требует отдельной проверки",
